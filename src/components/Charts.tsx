...
const Charts = () => {
    ...
    const { isLoading, error, data: covidData, isError } = useQuery({
        queryKey: ['covidData'],
        queryFn: async () => {
            // limiting no of data points for better visualization and
            // the patients who have recovered at later dates equates to 0 making it unusable
            const limitDataSet = 50 //560
